...
public class ParallaxItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(@NonNull Rect outRect, @NonNull View view, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
        ...
        // Calculate total spacing including both left and right
        int totalSpacing = spacing * (spanCount + 1);

        // Calculate the width of each item including spacing
        int itemWidth = (parent.getWidth() - totalSpacing) / spanCount;
