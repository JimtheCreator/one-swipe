...
//    RelativeLayout first_box;
    TextView state, sensitivity_txt, settings_text, c, d, e, f, g, h, i, j, troubleshoot, widgettext, appearancetext;
    ImageView closepage, restart_icon, k, l, m, n, widgeticon, arrowone, arrowtwo, arrowthree, arrowfour, arrowfive, appearanceicon,
            appearanceiconforward, appearanceiconbackwards;
    LinearLayout autorestartLayout, bottomparent, changeUILayout;
    RelativeLayout newUi, autorestart, instagramLay, contact, credits, theme, changesize, overlay, topParent, widgylayout, switchtonewUI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appearanceicon = findViewById(R.id.appearanceicon);
        appearanceiconforward = findViewById(R.id.appearanceiconforward);
        appearanceiconbackwards = findViewById(R.id.appearanceiconbackwards);
        appearancetext = findViewById(R.id.appearancetext);
...
//        first_box = findViewById(R.id.first_box);
        ...
        newUi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                appearanceiconbackwards.setVisibility(visible ? View.VISIBLE : View.GONE);
                appearanceiconforward.setVisibility(visible ? View.GONE : View.VISIBLE);
            }
...
//            TransitionManager.beginDelayedTransition(viewGroup);
    ...
    private void setDarkTheme() {
        ...
        appearanceiconforward.setImageDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.white_arrow_forward_ios_24));
        appearanceiconbackwards.setImageDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.white_keyboard_arrow_down_24));
        appearanceicon.setImageDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.baseline_color_lens_24));
        appearancetext.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.white));
